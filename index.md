...
* `uartdemo` - [an example plugin communicating with an Arduino Uno board over the serial port](https://create.arduino.cc/projecthub/catharanthus/yet-another-virtual-oscilloscope-for-arduino-e34ba4).
